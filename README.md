https://github.com/srinivasI/mern-employeefeedback
...
//Create a new record.
// the request made by 'fetch("http://localhost:5000/record")' in client
...
// It provides a UI to input employee details like name, email, and level.
          ...
          <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 ">
            ...
            <div>
              <fieldset className="mt-4">
                <legend className="sr-only">email Options</legend>
...
npm run dev
```
bc6920c2-8797-401e-94ad-11a14d19ec1b">
